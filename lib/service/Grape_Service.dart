...
class GrapeImageClassifyService extends ChangeNotifier {
  GrapeImageClassifyService() {
    loadModel();
  }
  ...
  Future loadModel() async {
     await Tflite.loadModel(
      model: 'assets/tflite/Grape_Model_Unquant.tflite',
      labels: 'assets/tflite/Grape_Label.txt',
