...
class CucumberImageClassifyService extends ChangeNotifier {
  CucumberImageClassifyService() {
    loadModel();
  }
  ...
  Future loadModel() async {
     await Tflite.loadModel(
      model: 'assets/tflite/model(TeachableMachine).tflite',
      labels: 'assets/tflite/Cucumber_Label.txt',
